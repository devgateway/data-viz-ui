...
import {buildDivergingOptions, buildPieOptions, buildBarOptions } from './prevalenceBuilder'
...
import { DataFrameProps } from "../map/types";
                    ...
                    {!showNotEnoughParameters && <DataConsumer>
                        ...
                        <ChartDataFrame
                            ...
                            <ColorProvider
                                ...
                                options={{
                                    data: parse(measures),
                                    dimensionsMetadata: parse(measures),
                                    measuresMetadata: parse(measures),
