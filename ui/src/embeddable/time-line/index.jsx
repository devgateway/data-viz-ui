    ...
    return (
        ...
        onMouseLeave={(event) => {
            ...
            {posts.map((p, i) => {
               ...
               style={{ left: isVisible ? tooltipData.position[0] : - 1000, top: isVisible ? tooltipData.position[1] : - 1000, position: 'absolute' , pointerEvents: closePopupOnMouseOut ? "none" : "all"}}>
                    <div className={"tooltip"} style={{ "backgroundColor": pointLineColor(i) , color: tooltipFontColor(i)}}>
