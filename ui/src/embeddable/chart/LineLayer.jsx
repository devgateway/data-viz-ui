...
const Line = (data, lineColor, layout, groupMode, keys, tooltipContent, title,measure) => injectIntl((props) => {
                ...
                {lineData.map(d => {
                    ...
                    return (
                        <circle
                            ...
                            onMouseMove={(event) => {
                                tooltip.html(formatContent(tooltipContent, { x: d[0], y: d[1] ,title,measure}, intl))
