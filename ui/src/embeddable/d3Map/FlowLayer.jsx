                        ...
                        .forEach(d2 => {
                            ...
                            this.g.append("path")
                                ...
                                .on("mouseenter", d => {
                                    ...
                                    g.selectAll("#arrow" + d1.properties[featureJoinAttribute]).transition().duration("200").style("opacity", 1)
                                    g.selectAll(".start-point.circle_" + d1.properties[featureJoinAttribute]).transition().duration("200").style("opacity", 1)
