...
class GradientColors {
    ...
    createGradient(gradientScheme, data, gradientReverse) {
        const gradientLimits = sequentialColors.find(sc => sc.value == gradientScheme) || {"startColor": "#ffffff",
            "endColor": "#000000"};
        ...
        const startRgb = hexToRgb(gradientReverse ? gradientLimits.endColor : gradientLimits.startColor);
        const endRgb = hexToRgb(gradientReverse ? gradientLimits.startColor : gradientLimits.endColor);
        const valueColors = [];
