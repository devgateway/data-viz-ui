...
const FilteredPosts = (props: FilteredPostsProps) => {
    ...
    return (
        <div ref={containerRef} id={`filtered-posts-${group}`} style={minHeight !== undefined ? { minHeight, border: '1px solid #e0e0e0', borderRadius: '4px', transition: 'border 0.2s' } : undefined}>
        <Container fluid>
            {
                loading ? (
