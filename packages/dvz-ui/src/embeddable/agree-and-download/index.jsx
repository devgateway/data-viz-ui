...
import { Button, Dialog, DialogContent, DialogHeader, DialogActions } from "@devgateway/ui";
        ...
        {slug && (
          <PostProvider locale={locale} type={type} slug={slug}>
            ...
            >
              ...
              <DialogContent>
                <DialogHeader className={"agreement-header"}>
                  <PostConsumer>
                    <svg
                      width="97"
                      height="97"
                ...
                <DialogActions className="agreement-footer">
                  <Button
